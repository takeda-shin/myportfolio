...
トップページの「ポートフォリオを作る」ボタンより。<br>
ポートフォリオのタイトルとキャッチコピーを入力し、「create」ボタンを押すことでポートフォリオのメイン画面と問い合わせフォームが作成される。<br>
【今後実装したい機能・内容】<br>
・デザインをアプリの雰囲気に合わせたものに変更<br>

### ポートフォリオメイン画面
![メイン画面](https://user-images.githubusercontent.com/55591073/77504006-72eb4500-6ea2-11ea-9c90-075e7f996aa2.png)
作成されたポートフォリオのメイン画面。作成者のみ上部にヘッダーが表示される（編集画面に遷移する「Edit」、トップページに戻る「Back」）<br>
【今後実装したい機能・内容】<br>
